...
function Warning() {
  return (
    <div className="flex items-center justify-between p-4 my-8 text-sm font-semibold text-purple-100 dark:text-white bg-black-100 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple">
